-- 기존 테이블 삭제 (역순으로 삭제하여 외래키 제약조건 위반 방지)
DROP TABLE IF EXISTS visitor_kpi CASCADE;
DROP TABLE IF EXISTS sales_daily CASCADE;
DROP TABLE IF EXISTS sns_daily CASCADE;
DROP TABLE IF EXISTS sns_feedback CASCADE;
